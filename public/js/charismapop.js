$(document).ready(function(){
	...
	{
	//commented for loading journal theme
		//$('#bs-css').attr('href','css/bootstrap-'+theme_name+'.css');
		$('#bs-css').attr('href','css/bootstrap-journal.css');
	}
...
// Added for View User - Modal pop-up by kamini
...
// Added for View Carrier - Modal pop-up by kamini
	
	$('.view-carrier').click(function(e){
		e.preventDefault();
		$('#viewCarrier').modal('show');
	});
...
// Added for View FAQ	
	...
	$('.view-variable').click(function(e){
		e.preventDefault();
		$('#viewVariable').modal('show');
	});
